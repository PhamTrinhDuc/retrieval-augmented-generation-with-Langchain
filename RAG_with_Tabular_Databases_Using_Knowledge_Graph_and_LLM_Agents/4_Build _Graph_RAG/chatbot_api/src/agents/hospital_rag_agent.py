...
from chains.hospital_qa_chain import reviews_vector_chain
from langchain import hub
from tools.wait_time import (
...
hospital_agent = create_openai_tools_agent(
    llm=chat_model,
    prompt=hospital_agent_prompt,
    tools=tools
)

hospital_agent_excutor = AgentExecutor(
...
# #     response = hospital_agent_excutor.invoke(
# #         {"input": "What is the wait time at Wallace-Hamiltion?"}
# #     )
